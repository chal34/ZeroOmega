...
const ruleProfile = OmegaPac.Profiles.byName(props.defaultProfileName, props.options)
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">{{ tr('options_modalHeader_resetRules') }}</h4>
          </div>
          <div class="modal-body">
            <p>{{ tr('options_resetRulesConfirm') }}</p>
            <div class="well">
          ...
          <div class="modal-footer">
            ...
            <button type="button" @click="emit('confirm')" class="btn btn-warning">{{ tr('options_resetRules') }}</button>
          </div>
        </div>
      </div>
    </div>
