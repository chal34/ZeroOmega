(this as any).UglifyJS_NoUnsafeEval = true;
...
$script('lib/spin.js/spin.js', function() {
  $script('lib/ladda/ladda.min.js', function() {
...
$script.ready(['angular', 'omega', 'omega-deps', 'angular-ui-router',
  ...
  'angular-sanitize', 'angular-i18n'], function() {
    const initInjector = angular.injector(['ng']);
    const $http = initInjector.get('$http');
    $http.get('./lib/themes/themes.json').then(function(response: any) {
