angular.module('omega').controller('PacProfileCtrl', function($scope: any, $modal: any) {
  ...
  let oldPacUrl: any = null;
  let oldLastUpdate: any = null;
  let oldPacScript: any = null;
  const onProfileChange = function(profile: any, oldProfile: any) {
